...
public class FriendsDyamicScreen extends Screen implements IXListViewListener, OnItemClickListener, IEventHandler {
    ...
    public void onRefresh() {
        if (ServiceManager.getUserId() == 0) {
            Toast.makeText(FriendsDyamicScreen.this, "请登录以后再刷新", Toast.LENGTH_SHORT).show();
        } else {
            if(dataArrayList.isEmpty())
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                FriendsDyamicScreen.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(FriendsDyamicScreen.this, "历史记录加载完毕", Toast.LENGTH_SHORT).show();
                        onLoad();
                    }
                });
            }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Toast.makeText(FriendsDyamicScreen.this, "position:" + position, Toast.LENGTH_SHORT).show();
