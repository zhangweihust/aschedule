...
public class ScheduleInfoScreen extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		editInfo = new BorderEditText(ScheduleInfoScreen.this, null);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case Menu.FIRST:
			...
			intent.setClass(ScheduleInfoScreen.this, ScheduleAllScreen.class);
	...
	public void handlerInfo(int scheduleID){
		...
		type.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				...
				new AlertDialog.Builder(ScheduleInfoScreen.this).setTitle("删除日程").setMessage("确认删除").setPositiveButton("确认", new OnClickListener() {
