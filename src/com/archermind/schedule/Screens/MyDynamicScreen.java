...
public class MyDynamicScreen extends Screen implements IXListViewListener, OnItemClickListener, IEventHandler  {
    ...
    private void onLoad() {
        list.stopRefresh();
        list.stopLoadMore();
        list.setRefreshTime(DateTimeUtils.time2String("yyyy-MM-dd hh:mm:ss", System.currentTimeMillis()));
    }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Toast.makeText(MyDynamicScreen.this, "position:" + position, Toast.LENGTH_SHORT).show();
    ...
    public boolean saveScheduleToDb(final String content, final int t_id) {
        ScheduleApplication.LogD(FriendsDyamicScreen.class,
                content + " id = " + t_id + " USER:" + ServiceManager.getUserId());
