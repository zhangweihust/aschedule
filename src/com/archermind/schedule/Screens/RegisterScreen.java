...
public class RegisterScreen extends Screen implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mpDialog = MyProgressDialog.getProgressDialog(RegisterScreen.this);
    ...
    public void Register() {
        ...
        new Thread() {
            public void run() {
                registerflag = true;
                String ret = ServiceManager.getServerInterface().register(email, pswd, username,
                        imsi, null, null, null, Integer.toString(binType), binId);
