 ...
 *
 */
public class CalendarConvertScreen extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		convertDate.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				new DatePickerDialog(CalendarConvertScreen.this, new OnDateSetListener() {
					...
					public void onDateSet(DatePicker view, int year, int monthOfYear,
						...
						if(year < 1901 || year > 2049){
							//不在查询范围内
							new AlertDialog.Builder(CalendarConvertScreen.this).setTitle("错误日期").setMessage("跳转日期范围(1901/1/1-2049/12/31)").setPositiveButton("确认", null).show();
						}else{
							year_c = year;
	...
	public String getLunarDay(int year, int month, int day) {
		...
		// {由于在取得阳历对应的阴历日期时，如果阳历日期对应的阴历日期为“初一“，就被设置成了月份
		//（如：四月，五月……等）}，所以在此就要判断得到的阴历日期是否为月份，如果是月份就设置为“初一“
