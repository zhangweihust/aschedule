...
import com.archermind.schedule.Utils.DownloadUtils;
...
public class AppUpgradeService extends Service{
    ...
    private static final String APK_SAVE_PATH ="/" + ScheduleApplication.getContext().getPackageName() + "/package/";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (Environment.getExternalStorageState().equals(android.os.Environment.MEDIA_MOUNTED)){
            destDir = new File(Environment.getExternalStorageDirectory().getPath() + APK_SAVE_PATH);
            if (destDir.exists()) {
