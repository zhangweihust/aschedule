     ...
     */
     void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        ...
        views.setTextViewText(R.id.title,
                DateTimeUtils.time2String("MM-dd EEEE", System.currentTimeMillis()));
        ...
        if (c != null) {
            ...
            if (c.getCount() > 0) {
                ...
                for (c.moveToFirst(); !c.isAfterLast(); c.moveToNext()) {
                    ...
                    time = DateTimeUtils.time2String("hh:mm",
                            c.getLong(c.getColumnIndex(DatabaseHelper.COLUMN_SCHEDULE_START_TIME)));
