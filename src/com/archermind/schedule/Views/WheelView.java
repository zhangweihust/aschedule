...
//					LunarCalendar.getLunarDate(Constant.VARY_YEAR, Constant.VARY_MONTH, Constant.VARY_DAY, true);
//					Constant.VARY_LUNAR_YEAR = LunarCalendar.getLunarYear()+"";
				}else if(calendar_flag == lunar_calendar_flag){
//					Constant.VARY_LUNAR_YEAR = text;
//					String solarDate = LunarCalendar.getSolar(Constant.VARY_LUNAR_YEAR, Constant.VARY_LUNAR_MONTH, Constant.VARY_LUNAR_DAY);
//					Constant.VARY_YEAR = Integer.parseInt(solarDate.split(",")[0]);
				}
...
//					LunarCalendar.getLunarDate(Constant.VARY_YEAR, Constant.VARY_MONTH, Constant.VARY_DAY, true);
//					Constant.VARY_LUNAR_MONTH = LunarCalendar.getLunarMonthNumber()+"";
				} catch (Exception e) {
//					if(text != null){
...
//						String solarDate = LunarCalendar.getSolar(Constant.VARY_LUNAR_YEAR, month, Constant.VARY_LUNAR_DAY);
//						Constant.VARY_MONTH = Integer.parseInt(solarDate.split(",")[1]);
//					}
				}
...
//					LunarCalendar.getLunarDate(Constant.VARY_YEAR, Constant.VARY_MONTH, Constant.VARY_DAY, true);
//					Constant.VARY_LUNAR_DAY = LunarCalendar.getLunarDayNumber()+"";
				} catch (Exception e) {
//					if(text != null){
//						String[] days = {"初一","初二","初三","初四","初五","初六","初七","初八","初九","初十","十一","十二",
