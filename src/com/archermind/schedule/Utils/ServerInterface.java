...
public class ServerInterface {
        ...
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                do {
                    ...
                    map.put("share", Integer.toString(cursor.getInt(cursor
                            .getColumnIndex(DatabaseHelper.COLUMN_SCHEDULE_SHARE))));
                    map.put("type", Integer.toString(cursor.getInt(cursor
                            .getColumnIndex(DatabaseHelper.COLUMN_SCHEDULE_TYPE))));
                    map.put("start_time", cursor.getString(cursor
                    ...
                    System.out.println("+++++++++++++++++++"
                            + cursor.getString(cursor
                                    .getColumnIndex(DatabaseHelper.COLUMN_SCHEDULE_OPER_FLAG)));
                    map.put("action", cursor.getString(cursor
                            .getColumnIndex(DatabaseHelper.COLUMN_SCHEDULE_OPER_FLAG)));
                    ...
                    if (text != null && text.equals("A")) {
                        ...
                        if (result >= 0) {
                            ...
                            // 删除当前记录
                            ServiceManager.getDbManager().deleteScheduleById(
                                    cursor.getInt(cursor
                                            .getColumnIndex(DatabaseHelper.COLUMN_SCHEDULE_ID)));
     ...
     */
    public static ArrayList<CalendarEventEntry> dateRangeQuery(CalendarService service,
            DateTime startTime, DateTime endTime) throws MalformedURLException {
    ...
    public static DateTime createtime(int year, int month, int day, int hour, int minute, int second) {
    ...
    // 读取日历数据
    public static String readCalendars(String userName, String userPassword, DateTime starttime,
            DateTime endtime) {
     ...
     * Action：default
     */
    public int checkSMS(String appid, String code, String smsID, String Action, String user_id,
            String tel, String imsi) {
        Map<String, String> map = new HashMap<String, String>();
        map.put("appid", appid);
        map.put("code", code);
        map.put("smsID", smsID);
    ...
    public static int uploadPhoto(String user_id, String url) {
        ...
        String res = HttpUtils.doPost(map,
