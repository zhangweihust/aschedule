...
public class AlbumInfoUtil {
    ...
    public static AlbumItem[] getAlbumInfos(AmtAlbumObj amtobj, Object data) {
        ...
        if (rMap.containsKey(Consts.ALBUMMAP_LIST)) {
            list = (ArrayList<Map<String, Object>>)(rMap.get(Consts.ALBUMMAP_LIST));
            ...
            if (size > 0) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    albumItems[i] = amtobj.constructAlbumItem(albumid, albumname, albumuser,
                            parentid, albumcover, albumurl, createtime);
    ...
    // 根据相册的名字查找相册的ID
    public static int getAlbumIdByName(AmtAlbumObj amtobj, Object data, String album) {
        int id = 0;
