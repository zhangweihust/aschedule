...
public class ScheduleOperateDialog implements OnClickListener{
	...
	public ScheduleOperateDialog(Context context,EventArgs args)
	{
		...
		schedule_operate_modify = (Button)dialog.findViewById(R.id.schedule_operate_modify);
		schedule_operate_delete = (Button)dialog.findViewById(R.id.schedule_operate_delete);
		schedule_operate_goback = (Button)dialog.findViewById(R.id.schedule_operate_goback);
