...
public class CitySettingDialog implements OnClickListener {
    ...
    // xml文件中对应的省份，城市的数组
    private int[] arrays = {
            R.array.beijing, R.array.shanghai, R.array.tianjin, R.array.chongqing, R.array.anhui,
            R.array.fujian, R.array.gansu, R.array.guangdong, R.array.guangxi, R.array.guizhou,
            R.array.hainan, R.array.hebei, R.array.henan, R.array.heilongjiang, R.array.hubei,
            R.array.hunan, R.array.jilin, R.array.jiangsu, R.array.jiangxi, R.array.liaoning,
            R.array.neimenggu, R.array.ningxia, R.array.qinghai, R.array.shandong,
            R.array.shanxi_01, R.array.shanxi_02, R.array.sichuan, R.array.xizang,
            R.array.xinjiang, R.array.yunnan, R.array.zhejiang,
    };
    ...
    public CitySettingDialog(Context context) {
        ...
        sp = context.getSharedPreferences("com.archermind.schedule_preferences",
    ...
    private void initPersonal() {
        ...
        two_char_provinces = context.getResources().getStringArray(R.array.two_chars_provinces);
    ...
    private void showDialog() {
        ...
        // 0: 默认第一个单选按钮被选中
        builder.setSingleChoiceItems(R.array.provinces, getProvincesId(province_text.getText()
                .toString()), new DialogInterface.OnClickListener() {

            public void onClick(DialogInterface dialog, int which) {

                provinceStr = context.getResources().getStringArray(R.array.provinces)[which];
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (provinceClickOrNot) {
                    provinceStr = context.getResources().getStringArray(R.array.provinces)[cityarrayId];
                    province_text.setText(provinceStr);
                    cities = (String[])context.getResources().getStringArray(arrays[cityarrayId]);
                    cityStr = context.getResources().getStringArray(arrays[cityarrayId])[0];
                    city_text.setText(cityStr);

                    ScheduleApplication.LogD(getClass(), "citydialog" + WeatherScreen.isChangeCity);
                    WeatherScreen.isChangeCity = true;
                    ScheduleApplication.LogD(getClass(), " after citydialog" + WeatherScreen.isChangeCity);

                } else {

                    pro_position = getProvincesId(province_text.getText().toString());

                    provinceStr = context.getResources().getStringArray(R.array.provinces)[pro_position];
                    cities = (String[])context.getResources().getStringArray(arrays[pro_position]);
                    cityStr = context.getResources().getStringArray(arrays[pro_position])[0];
                    province_text.setText(provinceStr);
                    city_text.setText(cityStr);
                }
            }
    ...
    private void showDialog(final boolean city) {
        ...
        if (city) {
            ...
            builder.setSingleChoiceItems(array, cityId, new DialogInterface.OnClickListener() {
                ...
                if (city) {
                    if (cityClickOrNot) {
                        ...
                        cityStr = context.getResources().getStringArray(
                                arrays[getProvincesId(province_text.getText().toString())])[cityId];
                        city_text.setText(cityStr);
                    }
                }
            }
