...
import com.android.schedule.Calendar.CalendarData;
import com.android.schedule.Calendar.LunarCalendar;
...
public class HistoryScheduleAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			// item.yearandmonth = (TextView)
			// convertView.findViewById(R.id.yearandmonth);
			...
			item.important = (ImageView) convertView
					.findViewById(R.id.important);
			// item.dateLayout = convertView.findViewById(R.id.date_layout);

			item.title_date = (TextView) convertView
					.findViewById(R.id.schedule_date);
			item.title_week = (TextView) convertView
					.findViewById(R.id.schedule_week);
			item.title_lunar = (TextView) convertView
					.findViewById(R.id.schedule_lunar);
			item.title_year_month = (TextView) convertView
					.findViewById(R.id.schedule_year_month);
			item.titleLayout = convertView.findViewById(R.id.date_title_layout);
			item.scheduleinfo = convertView
					.findViewById(R.id.local_schedule_item_info);
		...
		if (data.id == -1) {
			...
			// item.yearandmonth.setText(DateTimeUtils.time2String("yyyy年MM月",
			// data.time));
			// } else {
