...
import com.android.schedule.Screens.WeatherScreen;
...
public class WeatherDialog implements OnClickListener {
    ...
    private TextView todayWeather, oneDAfterWeather, twoDAfterWeather, threeDAfterWeather;
    ...
    private String mWeather1 = "", mWeather2 = "", mWeather3 = "", mWeather4 = "";
    ...
    public WeatherDialog(final Context context, int screenWidth, int screenHeight,
        ...
        citySettingDialog.getDialog().setOnDismissListener(new OnDismissListener() {
            ...
            public void onDismiss(DialogInterface dialog) {
                ...
                displayWeather(WeatherScreen.getCityInfoMap(), WeatherScreen.getWeatherMap(),
                        WeatherScreen.getItemsmap());
                province = mProvince;
                city = mCity;
    ...
    public void init() {
        ...
        todayCurTemp = (TextView)weatherDialog.findViewById(R.id.today_temperature);
        todayTemp = (TextView)weatherDialog.findViewById(R.id.today_temperature_range);
        todayWeather = (TextView)weatherDialog.findViewById(R.id.today_weather_condition);
        ...
        oneDAfterDate = (TextView)weatherDialog.findViewById(R.id.one_day_after_date);
        oneDAfterWeek = (TextView)weatherDialog.findViewById(R.id.one_day_after_week);
        oneDAfterImg = (ImageView)weatherDialog.findViewById(R.id.one_day_after_temperature_img);
        oneDAfterMinTemp = (TextView)weatherDialog.findViewById(R.id.one_day_after_min_temperature);
        oneDAfterMaxTemp = (TextView)weatherDialog.findViewById(R.id.one_day_after_max_temperature);
        oneDAfterWeather = (TextView)weatherDialog.findViewById(R.id.one_day_after_condition);

        twoDAfterDate = (TextView)weatherDialog.findViewById(R.id.two_day_after_date);
        twoDAfterWeek = (TextView)weatherDialog.findViewById(R.id.two_day_after_week);
        twoDAfterImg = (ImageView)weatherDialog.findViewById(R.id.two_day_after_temperature_img);
        twoDAfterMinTemp = (TextView)weatherDialog.findViewById(R.id.two_day_after_min_temperature);
        twoDAfterMaxTemp = (TextView)weatherDialog.findViewById(R.id.two_day_after_max_temperature);
        twoDAfterWeather = (TextView)weatherDialog.findViewById(R.id.two_day_after_condition);

        threeDAfterDate = (TextView)weatherDialog.findViewById(R.id.three_day_after_date);
        threeDAfterWeek = (TextView)weatherDialog.findViewById(R.id.three_day_after_week);
        ...
        threeDAfterWeather = (TextView)weatherDialog.findViewById(R.id.three_day_after_condition);

        cancelBtn = (Button)weatherDialog.findViewById(R.id.weather_dialog_cancel);
