...
import com.android.schedule.Utils.FileUtils;
...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public static final String COLUMN_SCHEDULE_NOTICE_MONTHDAY = "notice_monthday";// 闹钟按每月重复提醒的日（本地，取的是notice_day
																					// 中的日）
	public static final String COLUMN_SCHEDULE_NOTICE_YEARDAY = "notice_yearday";// 闹钟按每年重复提醒的月和日（本地，取的是notice_day
																					// 中的日，月）
	...
	private static final String CREATE_CONTACT_TABLE = " CREATE TABLE IF NOT EXISTS "
			...
			+ " TEXT, "
			+ ASCHEDULE_CONTACT_NAME
			+ " TEXT, "
			+ ASCHEDULE_CONTACT_IMGPATH
			+ " TEXT, " + ASCHEDULE_CONTACT_TYPE + " INTEGER DEFAULT '0' "
	...
	private static final String CREATE_FRIEND_TABLE = " CREATE TABLE IF NOT EXISTS "
			...
			+ ASCHEDULE_FRIEND_ID
			+ " INTEGER PRIMARY KEY, "
			+ ASCHEDULE_FRIEND_NUM
			+ " TEXT, "
			+ ASCHEDULE_FRIEND_NAME
			+ " TEXT, "
			+ ASCHEDULE_FRIEND_NICK
			+ " TEXT, "
			+ ASCHEDULE_FRIEND_PHOTO_URL
			+ " TEXT, "
